"""
ORIGINAL WORKING NOTEBOOK - Cell 2 (Summary Builder)
This is your working script BEFORE adding individuals.
Copy this into AGOL Notebook if you need to restore.
"""
